...
// BulkToggleJobExecutionResponseTestFile is the test data for a BulkToggleJobExecutionResponse
const BulkToggleJobExecutionResponseTestFile = "bulk_toggle_execution.json"

// BulkToggleJobExecutionResponse represents a bulk job delete response
type BulkToggleJobExecutionResponse struct {
	RequestCount  int                   `json:"requestCount"`
	AllSuccessful bool                  `json:"allSuccessful"`
	Enabled       bool                  `json:"enabled"`
	Succeeded     []BulkJobEntryReponse `json:"succeeeded"`
...
// FromReader returns a BulkToggleJobExecutionResponse from an io.Reader
func (a *BulkToggleJobExecutionResponse) FromReader(i io.Reader) error {
	b, err := ioutil.ReadAll(i)
	if err != nil {
		return err
	}
...
// FromFile returns a BulkToggleJobExecutionResponse from a file
func (a *BulkToggleJobExecutionResponse) FromFile(f string) error {
	file, err := os.Open(f)
	defer func() { _ = file.Close() }()
	if err != nil {
		return err
...
// FromBytes returns a BulkToggleJobExecutionResponse from a byte slice
func (a *BulkToggleJobExecutionResponse) FromBytes(f []byte) error {
	file := bytes.NewReader(f)
	return a.FromReader(file)
}

// BulkToggleJobScheduleResponseTestFile is the test data for a BulkToggleJobScheduleResponse
const BulkToggleJobScheduleResponseTestFile = "bulk_toggle_schedule.json"

// BulkToggleJobScheduleResponse represents a bulk job delete response
type BulkToggleJobScheduleResponse struct {
	RequestCount  int                   `json:"requestCount"`
	AllSuccessful bool                  `json:"allSuccessful"`
	Enabled       bool                  `json:"enabled"`
	Succeeded     []BulkJobEntryReponse `json:"succeeeded"`
...
// FromReader returns a BulkToggleJobScheduleResponse from an io.Reader
func (a *BulkToggleJobScheduleResponse) FromReader(i io.Reader) error {
	b, err := ioutil.ReadAll(i)
	if err != nil {
		return err
	}
...
// FromFile returns a BulkToggleJobScheduleResponse from a file
func (a *BulkToggleJobScheduleResponse) FromFile(f string) error {
	file, err := os.Open(f)
	defer func() { _ = file.Close() }()
	if err != nil {
		return err
...
// FromBytes returns a BulkToggleJobScheduleResponse from a byte slice
func (a *BulkToggleJobScheduleResponse) FromBytes(f []byte) error {
	file := bytes.NewReader(f)
	return a.FromReader(file)
}
